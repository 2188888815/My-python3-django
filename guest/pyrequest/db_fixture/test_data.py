...
'''
init_data()函数用于读取 datas 字典中的数据， 
调用 DB 类中的 clear()方法清除数据库， 然后， 调用 insert()方法插入表数据。
'''
# create data
datas = {
    'sign_event': [
    ...
    'sign_guest':[
        {'id': 1, 'realname': 'alen', 'phone': 13511001100, 'email': 'alen@mail.com', 'sign': 0, 'event': 1},
        {'id': 2, 'realname': 'has sign', 'phone': 13511001101, 'email': 'sign@mail.com', 'sign': 1, 'event': 1},
        {'id': 3, 'realname': 'tom', 'phone': 13511001102, 'email': 'tom@mail.com', 'sign': 0, 'event': 5},
    ],
}
